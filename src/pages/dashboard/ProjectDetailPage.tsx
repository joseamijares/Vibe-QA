...
export function ProjectDetailPage() {
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-gray-600">
                  Use this key to authenticate widget requests. Keep it secure and do not share it
                  publicly.
                </p>
              </div>
            </Card>
  ...
  async>
                ...
                <ol className="text-sm text-gray-600 space-y-2">
                  ...
                  <li>2. Add it to your HTML before the closing &lt;/body&gt; tag</li>
                  <li>3. The widget will automatically appear on your page</li>
                </ol>
        ...
        <TabsContent value="team">
          <ProjectTeamSettings projectId={project.id} />
        </TabsContent>
      </Tabs>
    </div>
  );
